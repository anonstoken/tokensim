...
import "hardhat/console.sol";
    ...
    contract MultiChainCapital is Context, IERC20, Ownable {
        ...
        function getRTBalance(address acc) public view returns(uint256, uint256) {
            return (_rOwned[acc], _tOwned[acc]);
        }
        ...
        function _tokenTransfer(address sender, address recipient, uint256 amount, bool takeFee) private {
            console.log("_tokenTransfer", sender, recipient, takeFee);
            if(!takeFee)
                removeAllFee();
        ...
        function _transferStandard(address sender, address recipient, uint256 tAmount) private {
            console.log("_transferStandard", sender, recipient, tAmount);
        ...
        function _getValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256, uint256, uint256) {
            console.log("_getValues(tAmount=%s)", tAmount);
